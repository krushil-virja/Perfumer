					...
					<div class="card-body">
						...
						<form action="updateController" method="post"
							...
							<div class="col-12">
								...
								<input name="pname" value="${p.pname }" type="text" class="form-control"
									id="inputNanme4">
							</div>
							<div class="col-12">
							...
							<div class="col-12">
								<label for="inputEmail4" class="form-label">Product
									Brand</label> <input name="pbrand" value="${p.pbrand}" type="text" class="form-control">
							</div>

							<div class="col-12">
								<label for="inputEmail4" class="form-label">Product
									Price</label> <input name="price" value="${p.price}" type="text" class="form-control"
									id="inputEmail4">
							</div>
						 ...
						 <input type="hidden" name=timedurestion value="<%=formatDateTime%>"> 
							...
							<div class="row mt-3">
								...
								<div class="col-sm-10">
									<textarea  name="discription" value="${p.discription}" class="form-control" style="height: 100px"></textarea>
								</div>
							</div>
							...
							<div class="row mt-3">
								...
								<div class="col-sm-10">
									<textarea  name="information" value="${p.information}" class="form-control" style="height: 100px"></textarea>
								</div>
							</div>
